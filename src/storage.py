...
class StorageBackend(ABC):
    ...
    @abstractmethod
    def save(
        self, benchmark_id: str, entity_type: str, entity_id: str, data: Dict[str, Any]
    ) -> bool:
        """
    ...
    @abstractmethod
    def load(
        self, benchmark_id: str, entity_type: str, entity_id: str
        ...
        try:
            ...
            if csv_path.exists():
                with open(csv_path, "r", newline="") as f:
                    ...
                    existing_data = [
                        row for row in reader if row.get("_id") != entity_id
                    ]
...
class StorageManager:
    ...
    def load_all_entities(
        self, benchmark_id: str, entity_type: str
    ) -> List[Dict[str, Any]]:
        """
