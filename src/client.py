...
class Client:
    ...
    @classmethod
    def load(cls, benchmark_id: str, client_name: str, 
             storage_manager: Optional[StorageManager] = None) -> Optional["Client"]:
        """
    ...
    def load_all(cls, benchmark_id: str, 
                 storage_manager: Optional[StorageManager] = None) -> List["Client"]:
        """
